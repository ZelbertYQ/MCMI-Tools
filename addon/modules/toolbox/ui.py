...
class MCMI_MergeVertexGroups(bpy.types.Operator):
    bl_idname = "mcmi_tools.merge_vertex_groups"
...
class MCMI_FillGapsInVertexGroups(bpy.types.Operator):
    """
    ...
    """
    bl_idname = "mcmi_tools.fill_gaps_in_vertex_groups"
...
class MCMI_RemoveUnusedVertexGroups(bpy.types.Operator):
    """
    Remove all vertex groups from selected objects
    """
    bl_idname = "mcmi_tools.remove_unused_vertex_groups"
...
class MCMI_RemoveAllVertexGroups(bpy.types.Operator):
    """
    Remove all vertex groups from selected objects
    """
    bl_idname = "mcmi_tools.remove_all_vertex_groups"
...
class MCMI_ApplyModifierForObjectWithShapeKeysOperator(bpy.types.Operator):
    bl_idname = "mcmi_tools.apply_modifier_for_object_with_shape_keys"
...
class MCMI_CreateMergedObject(bpy.types.Operator):
    bl_idname = "mcmi_tools.create_merged_object"
...
class MCMI_ApplyMergedObjectSculpt(bpy.types.Operator):
    bl_idname = "mcmi_tools.apply_merged_object_sculpt"
...
class MCMI_ApplyMergedObjectSculptWithShapekeys(bpy.types.Operator):
    bl_idname = "mcmi_tools.apply_merged_object_sculpt_with_shapekeys"
...
class MCMI_ConvertVertexColors(bpy.types.Operator):
    bl_idname = "mcmi_tools.convert_vertex_colors"
