...
class IniMakerOld(IniMaker):
    ...
    def make_autogenerated_group(self):
        msg = 'This mod.ini was automatically generated by MCMI Tools Blender addon v%s and requires WWMI v%s+ to function' % (
            self.mod_info.mcmi_tools_version, self.mod_info.required_wwmi_version
        )
